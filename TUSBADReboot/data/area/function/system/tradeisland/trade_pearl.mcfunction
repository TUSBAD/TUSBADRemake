...
execute as @e[type=ender_pearl,predicate=area:area/tradeisland] on origin run playsound minecraft:block.glass.break master @a[sort=nearest,limit=1] ~ ~ ~ 0.3 0.5
execute as @e[type=ender_pearl,predicate=area:area/tradeisland] at @s if data entity @s Owner run kill @s
