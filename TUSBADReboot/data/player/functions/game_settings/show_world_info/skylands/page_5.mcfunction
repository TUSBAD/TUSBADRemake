...
tellraw @s ""
tellraw @s [{"translate":"エンドポータル島","color":"#ff5353"}," : ",{"storage":"area:","nbt":"capture.skylands{044:0}.044","font":"ender_eye","color":"gray"},{"storage":"area:","nbt":"capture.skylands{044:1}.044","font":"ender_eye","color": "white"}]
tellraw @s [{"translate":"混沌群島","color":"#b76fff"}," : ",{"storage":"area:","nbt":"capture.skylands{045:0}.045","font":"ender_eye","color":"gray"},{"storage":"area:","nbt":"capture.skylands{045:1}.045","font":"ender_eye","color": "white"}]
tellraw @s ""
tellraw @s ""
tellraw @s ""
tellraw @s ""
