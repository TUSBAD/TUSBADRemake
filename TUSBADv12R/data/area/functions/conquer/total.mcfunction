...
execute if data storage tusb_remake: {_:false} in minecraft:overworld as @e[x=-1902,y=4,z=-81,dx=24,type=villager,tag=!ShopStaff,sort=random,limit=1] at @s run function area:conquer/new_shop
