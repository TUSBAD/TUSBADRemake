...
### プレイヤーの回復効果
execute as @a[scores={HealCount=1..3},nbt=!{ActiveEffects:[{Id:10b}]}] run function tusb_remake:player/heal/small
execute as @a[scores={HealCount=4..},nbt=!{ActiveEffects:[{Id:6b}]}] run function tusb_remake:player/heal/large
