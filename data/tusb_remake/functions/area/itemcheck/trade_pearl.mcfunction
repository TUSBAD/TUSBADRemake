...
execute as @e[type=ender_pearl,predicate=tusb_remake:area/tradeisland] at @s if data entity @s Owner run playsound minecraft:block.glass.break master @a[sort=nearest,limit=1] ~ ~ ~ 0.3 0.5
