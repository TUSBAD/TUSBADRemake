...
execute positioned ~-7 ~ ~ as @e[dx=14,type=#tusb_remake:mob,tag=Enemy,nbt=!{ActiveEffects:[{Id:23b}]}] run function tusb_remake:skill/black_mage/cross_fire/schedule/hit
execute positioned ~ ~-7 ~ as @e[dy=14,type=#tusb_remake:mob,tag=Enemy,nbt=!{ActiveEffects:[{Id:23b}]}] run function tusb_remake:skill/black_mage/cross_fire/schedule/hit
execute positioned ~ ~ ~-7 as @e[dz=14,type=#tusb_remake:mob,tag=Enemy,nbt=!{ActiveEffects:[{Id:23b}]}] run function tusb_remake:skill/black_mage/cross_fire/schedule/hit
