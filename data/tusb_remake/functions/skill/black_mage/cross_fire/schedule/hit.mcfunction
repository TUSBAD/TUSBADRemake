...
execute if entity @s[type=#tusb_remake:burnable,nbt=!{ActiveEffects:[{Id:12b}]}] store result storage score_damage: Argument.Damage double 0.03 run data get storage score_damage: Argument.Damage 100
### ダメージを与える
