...
execute positioned ~-0.5 ~ ~-0.5 as @e[dy=0,type=#tusb_remake:mob,tag=Enemy,nbt=!{ActiveEffects:[{Id:23b}]},limit=1] at @s run function tusb_remake:skill/summoner/blast_basin/schedule/hit
