...
# 軽減不可ダメージ
  # 引数を設定
    ...
    execute as @s[scores={DoomEX=15..29}] run data modify storage score_damage: Argument.Damage set value 7
    execute as @s[scores={DoomEX=1..14}] run data modify storage score_damage: Argument.Damage set value 10
