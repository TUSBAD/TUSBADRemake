...
title @s[scores={DoomEX=0..19}] actionbar [{"text":"☠ ","color":"#d900ce","italic":false},{"text":"< ","color":"dark_green","bold":true},{"score":{"name":"*","objective":"DoomEX"},"color":"#d200d2","bold":false,"italic":false},{"text":"秒","color":"light_purple","bold":true,"italic":false},{"text":" >","color":"dark_green","bold":true,"italic":false},{"text":" ☠","color":"#d900ce","italic":false}]
