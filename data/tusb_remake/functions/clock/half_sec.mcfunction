...
execute as @a[predicate=tusb_remake:fluid_gimmic_area,predicate=tusb_remake:is_in_water/include_flowing,predicate=tusb_remake:area/deadwater] at @s run function tusb_remake:clock/gimmic/fluid/deadwater_damage
