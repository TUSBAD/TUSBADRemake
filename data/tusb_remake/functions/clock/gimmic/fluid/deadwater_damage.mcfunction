...
# 軽減不可ダメージ
  # 引数を設定
    data modify storage score_damage: Argument set value {Damage:10,EPF:0,BypassArmor:true,BypassResistance:true,DeathCause:'[{"translate":"%1$sは%2$s。","with":[{"selector":"@s"},{"translate":"命を消された","color":"#aa00ea","bold":true}]}]'}
