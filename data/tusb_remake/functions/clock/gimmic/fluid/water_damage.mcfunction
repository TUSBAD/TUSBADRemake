...
# 軽減不可ダメージ
  # 引数を設定
    data modify storage score_damage: Argument set value {Damage:4,EPF:0,BypassArmor:true,BypassResistance:true,DeathCause:'[{"translate":"%1$sは%2$sしまった。","with":[{"selector":"@s"},{"translate":"体が溶けて","color":"#0fc400","bold":true}]}]'}
