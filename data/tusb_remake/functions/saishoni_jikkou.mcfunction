...
### ベッドに触れた処理
execute as @a at @s run function tusb_remake:player/spawn/check_sleep
...
### MobGriefingの修正
execute store result score MobGriefing Settings run gamerule mobGriefing
execute if score MobGriefing Settings matches ..0 run gamerule mobGriefing true
### ハード固定
difficulty hard
