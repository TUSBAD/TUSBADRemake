...
execute if score Sightseeing Settings matches 1.. run data modify storage tusb_remake: _ set value "(観光モード)"
tellraw @s {"text":"—- 攻略率 —-","color":"white","bold":true}
tellraw @s {"translate":"全エリア %1$s/%2$s (%3$s.%4$s%%) %5$s経過","color":"white","bold":false,"with":[{"nbt":"conquer.count.total","storage":"tusb_remake:","bold":true,"italic":false},{"score":{"name":"MaxPortalCount","objective":"Settings"}},{"nbt":"conquer.rate.int[]","storage":"tusb_remake:","separator":""},{"nbt":"conquer.rate.cent[]","storage":"tusb_remake:","separator":""}]}
tellraw @s [{"translate":"%1$s時間%2$s分%3$s秒","italic":false,"bold":false,"color":"white","with":[{"nbt":"out.total_hour","storage":"math:"},{"nbt":"out.minute","storage":"math:"},{"nbt":"out.second","storage":"math:"}]},{"nbt":"_","storage":"tusb_remake:"}]
