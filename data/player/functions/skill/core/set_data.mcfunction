...
##デバッグ用
# ストレージ検証 (Error Check)
    execute unless data storage tusb_remake:skill Temp.Job run tellraw @a [{"translate":"ERROR ","color":"red"},{"translate":"引数が足りません ","color":"white"},{"translate":"Job","color":"red"}]
    execute unless data storage tusb_remake:skill Temp.ID run tellraw @a [{"translate":"ERROR ","color":"red"},{"translate":"引数が足りません ","color":"white"},{"translate":"ID","color":"red"}]
    execute unless data storage tusb_remake:skill Temp.Mode run tellraw @a [{"translate":"ERROR ","color":"red"},{"translate":"引数が足りません ","color":"white"},{"translate":"Mode","color":"red"}]
    execute unless data storage tusb_remake:skill Temp.Name run tellraw @a [{"translate":"ERROR ","color":"red"},{"translate":"引数が足りません ","color":"white"},{"translate":"Name","color":"red"}]
    execute unless data storage tusb_remake:skill Temp.MPCost run tellraw @a [{"translate":"ERROR ","color":"red"},{"translate":"引数が足りません ","color":"white"},{"translate":"MPCost","color":"red"}]
    execute unless data storage tusb_remake:skill Temp.Interval run tellraw @a [{"translate":"ERROR ","color":"red"},{"translate":"引数が足りません ","color":"white"},{"translate":"Interval","color":"red"}]
##ジョブストレージ格納
# デバッグ用職業
